...
namespace TeamTracker.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(TeamTrackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("project_code,project_name")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("project_code,project_name")] Project project)
        {
